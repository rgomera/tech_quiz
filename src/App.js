      ...
      <>
         <Router>
            <Routes>
               ...
               <Route path='/login' element={!user ? <Signin setUser={setUser} /> : <Navigate replace to='/' />} />
               ...
               />
               <Route path='/journal-entries' element={user ? <JournalEntries user={user} /> : <Navigate replace to='/login' />} />
            </Routes>
         </Router>
